...
{
	if (region.aM.ad === region.aY.ad)
	{
		return 'on line ' + region.aM.ad;
	}
	return 'on lines ' + region.aM.ad + ' through ' + region.aY.ad;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cm: 'hidden', b4: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cm: 'mozHidden', b4: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cm: 'msHidden', b4: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cm: 'webkitHidden', b4: 'webkitvisibilitychange' }
		: { cm: 'hidden', b4: 'visibilitychange' };
}
...
var $author$project$Models$init = {
	...
	cU: _List_fromArray(
		['Разработка сайтов', 'Оптимизация производительности', 'Консультации']),
	cW: false,
	c6: _List_fromArray(
		['Отличный разработчик!', 'Очень доволен результатом.', 'Профессионал своего дела.'])
};
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {a$: fragment, a4: host, bh: path, bj: port_, bm: protocol, bn: query};
	});
...
var $author$project$Views$Contacts$view = function (contacts) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Views$Header$view = F2(
	function (name, bio) {
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
...
var $author$project$Views$Links$view = A2(
	$elm$html$Html$div,
	_List_fromArray(
		[
			$elm$html$Html$Attributes$class('section')
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Attributes$class('button is-link'),
									$elm$html$Html$Attributes$href('https://linkedin.com'),
									$elm$html$Html$Attributes$target('_blank')
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Мой LinkedIn')
								]))
						]))
				]))
		]));
var $author$project$Views$Portfolio$view = function (portfolio) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Views$Services$view = function (services) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Messages$ToggleTestimonials = 0;
...
var $author$project$Views$Testimonials$view = F2(
							...
							A2(
								...
								function (testimonial) {
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text(testimonial)
											]));
								},
								testimonials)) : $elm$html$Html$text('')
						]))
				]));
	});
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($author$project$Views$Header$view, model.cC, model.bV),
				$author$project$Views$Contacts$view(model.b9),
				$author$project$Views$Portfolio$view(model.cL),
				$author$project$Views$Services$view(model.cU),
				A2($author$project$Views$Testimonials$view, model.cW, model.c6),
				$author$project$Views$Links$view
			]));
};
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{cs: $author$project$Models$init, dq: $author$project$Updates$update, dr: $author$project$Main$view});
